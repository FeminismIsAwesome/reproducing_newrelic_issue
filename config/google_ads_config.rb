...
Google::Ads::GoogleAds::Config.new do |c|
  ...
  c.client_id = ENV["GOOGLE_OAUTH_2_CLIENT_ID"]
  c.client_secret = ENV["GOOGLE_OAUTH_2_CLIENT_SECRET"]
  c.refresh_token = ENV["GOOGLE_OAUTH2_REFRESH_TOKEN"]
  ...
  # value.
  c.login_customer_id = ENV["GOOGLE_ADS_MANAGER_CUSTOMER_ID"]
